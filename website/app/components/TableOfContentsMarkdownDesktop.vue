<template>
  <div class="hidden lg:sticky lg:top-[0px] lg:h-screen lg:flex lg:flex-col lg:min-w-[300px]">
    <TableOfContentsHighlight
      ...
      :links-class="`block text-sm py-2 border-t-1 border-t-gray-300 dark:border-t-gray-500 toc-highlight-transition ${ANCHOR_COLOR_TAILWIND_STYLE}`"
