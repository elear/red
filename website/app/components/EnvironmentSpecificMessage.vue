    ...
    >
        <DialogTrigger>
            <button
                ...
                <div
                    class="button-shimmer-target px-3 py-0 sm:py-1 uppercase font-bold text-yellow-100 text-xs md:text-sm rounded-md border-3 border-double border-yellow-500 shadow-xl text-shadow-lg bg-radial from-yellow-600 to-yellow-700 tracking-wide"
                ...
                <div>
                    <div
                        ...
                        <Icon
                            name="garden:speech-bubble-plain-fill-12"
                            size="1em"
                        />
                    </div>
                </div>
            ...
            <DialogContent class="fixed top-0 left-[50%] -ml-[10em] z-100 overflow-y-auto max-h-screen">
                <div
                    ...
                    <div class="text-sm">
                        ...
                        <div
                            class="font-mono block bg-gray-100 dark:bg-gray-800 text-xs dark:text-white p-2 border-1 border-gray-300 dark:border-gray-500  no-underline"
                            rows="4"
                        >
